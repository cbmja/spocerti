...
/*textarea 생성*/ //ok
    function addTextarea(subjectCode, subjectTitle) {
        ...
        if ($('#textarea-' + subjectCode).length === 0) {
            var textarea = '<div id="subject-' + subjectCode + '"><label>' + subjectTitle + '</label><br><textarea name="subjectCode-'+subjectCode+'" rows="4" cols="50" data-subjectcode="'+subjectCode+'"></textarea><br></div>';
